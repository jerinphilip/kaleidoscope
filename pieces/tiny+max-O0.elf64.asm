...
_Z3maxii:
        push    rbp
        mov     rbp, rsp
        mov dword [rbp-4], edi ; mov     DWORD PTR [rbp-4], edi
        mov dword [rbp-8], esi ; mov     DWORD PTR [rbp-8], esi
        mov dword [rbp-4], eax ; mov     eax, DWORD PTR [rbp-4]
        cmp dword [rbp-8], eax ; cmp     eax, DWORD PTR [rbp-8]
        jle     .L2
        mov dword [rbp-4], eax ; mov     eax, DWORD PTR [rbp-4]
        jmp     .L3
  .L2:
        mov dword [rbp-8], eax ; mov     eax, DWORD PTR [rbp-8]
  .L3:
        pop     rbp
        ret
